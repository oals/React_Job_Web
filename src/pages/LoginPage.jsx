...
const LoginPage = ({ setIsLogin }) => {
  ...
  return (
    <div className=" mx-auto flex-column border border-1 rounded shadow-lg p-4" style={{ marginTop: '90px', width: '50%' }}>
      <div className="d-flex flex-column mt-0">
        <span className="fw-semibold text-dark" style={{ fontSize: '1.5rem' }}>로그인 </span>
        <span className=" text-secondary " style={{ fontSize: '1.0rem' }}>환영합니다 다시 만나서 기뻐요 </span>
      </div>
