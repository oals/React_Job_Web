            ...
            <div className="d-flex align-items-start mt-5" style={{width: '75%'}}>
                <div className="w-50 d-flex justify-content-end">
                 ...
                 <div className="w-100 mx-5 d-flex text-start align-items-start flex-column">
                     <span className="fw-bold" style={{fontSize: '2.0rem'}}>Software Engineer</span>
                    <p class="text-secondary leading-relaxed mt-3" style={{fontSize: '1.2rem'}}>
                        소프트웨어 엔지니어는 창의성과 논리적 사고를 바탕으로 다양한 문제를 해결하는 매력적인 직업입니다. 끊임없이 발전하는 기술을 학습하며 새로운 솔루션을 만들어내는 과정에서 큰 성취감을 느낄 수 있습니다. 협업을 통해 더 큰 가치를 창출하고, 자신의 코드가 세상에 긍정적인 영향을 미치는 것을 직접 확인할 수 있습니다.
                    </p>
